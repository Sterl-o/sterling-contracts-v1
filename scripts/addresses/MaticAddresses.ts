...
export class ArbitrumAddresses {

  public static ZERO_ADDRESS = "0x0000000000000000000000000000000000000000";

  // tokens
  public static WETH_TOKEN = "0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270".toLowerCase();
  ...
  public static STR_TOKEN = "0x39aB6574c289c3Ae4d88500eEc792AB5B947A5Eb".toLowerCase();
