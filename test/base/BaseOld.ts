...
describe("base old tests", function () {
  ...
  let mim: Token;
  let dai: Token;
  let ve_underlying: Str;
  let late_reward: Token;
  let ve: Ve;
  let factory: StrFactory;
  let router: StrRouter01;
  let pair: StrPair;
  let pair2: StrPair;
  let pair3: StrPair;
  ...
  it("deploy StrFactory and test pair length", async function () {
    const treasury = await Deploy.deployGovernanceTreasury(owner);
    const StrFactory = await ethers.getContractFactory("StrFactory");
    factory = await StrFactory.deploy(treasury.address);
    await factory.deployed();

    expect(await factory.allPairsLength()).to.equal(0);
  });

  it("deploy StrRouter01 and test factory address", async function () {
    const StrRouter01 = await ethers.getContractFactory("StrRouter01");
    router = await StrRouter01.deploy(factory.address, owner.address);
    await router.deployed();

    expect(await router.factory()).to.equal(factory.address);
  });

  it("deploy pair via StrFactory owner", async function () {
  ...
  it("deploy pair via StrFactory owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const dai_1 = ethers.BigNumber.from("1000000000000000000");
  ...
  it("StrRouter01 addLiquidity", async function () {
  ...
  it("StrRouter01 removeLiquidity", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("StrRouter01 addLiquidity owner2", async function () {
    const ust_1000 = ethers.BigNumber.from("100000000000");
    const mim_1000 = ethers.BigNumber.from("100000000000000000000000");
    const mim_100000000 = ethers.BigNumber.from("100000000000000000000000000");
    const dai_100000000 = ethers.BigNumber.from("100000000000000000000000000");
  ...
  it("StrRouter01 pair1 getAmountsOut & swapExactTokensForTokens", async function () {
  ...
  it("StrRouter01 pair1 getAmountsOut & swapExactTokensForTokens owner2", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
    const route = {from: ust.address, to: mim.address, stable: true}
  ...
  it("StrRouter01 pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const ust_1 = ethers.BigNumber.from("1000000");
  ...
  it("StrRouter01 pair3 getAmountsOut & swapExactTokensForTokens", async function () {
  ...
  it("deploy StrVoter", async function () {
    ...
    const StrVoter = await ethers.getContractFactory("StrVoter");
    voter = await StrVoter.deploy(ve.address, factory.address, gauges_factory.address, bribe_factory.address);
  ...
  it("deploy Minter", async function () {
    ...
    const Minter = await ethers.getContractFactory("StrMinter");
  ...
  it("deploy StrFactory gauge", async function () {
  ...
  it("veSTR gauge manipulate", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
  ...
  it("deploy StrFactory gauge owner2", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
  ...
  it("StrRouter01 pair1>pair2 getAmountsOut & swapExactTokensForTokens", async function () {
    const mim_1 = ethers.BigNumber.from("1000000000000000000");
    const route = [{from: mim.address, to: ust.address, stable: false}, {
      from: ust.address,
      to: mim.address,
  ...
  it("StrRouter01 addLiquidity owner3", async function () {
  ...
  it("deploy StrFactory gauge owner3", async function () {
    const pair_1000 = ethers.BigNumber.from("1000000000");
